...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.results = [[[MOBDataManager sharedManager] managedObjectContext] executeFetchRequest:fetchRequest error:NULL];
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    App * app = self.results[indexPath.row];
    NSLog(@"w %@", app.o_title);
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([segue.identifier isEqualToString:@"toLayer"]) {
        App * app = [self.results objectAtIndex:self.tableView.indexPathForSelectedRow.row];
